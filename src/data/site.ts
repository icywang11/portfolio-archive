...
export const internships = [
  {
    ...
    bullets: [
      ...
      "Excel 社区看板支撑决策，后续活动参与率提升约 18%",
      "《燕云十六声》《全明星街球派对》Discord 社区基建优化",
      "4 个社区、189 场活动、20 万参与人次收进同一张看板",
    ],
  },
  {
    company: "POIZON",
...
export const hobbies = [
  ...
  },
  {
    ...
    tab: "Reading",
    title: "阅读",
    note: "哲学与经济：一边读人怎么活，一边读事怎么做成。",
    slides: [
      { src: "/authors/hesse.jpg", alt: "黑塞", caption: "黑塞" },
      { src: "/authors/yuhua.jpg", alt: "余华", caption: "余华" },
      { src: "/authors/eileen.jpg", alt: "张爱玲", caption: "张爱玲" },
      { src: "/authors/luxun.jpg", alt: "鲁迅", caption: "鲁迅" },
      { src: "/authors/marquez.jpg", alt: "马尔克斯", caption: "马尔克斯" },
      { src: "/authors/camus.jpg", alt: "加缪", caption: "加缪" },
      { src: "/authors/kafka.jpg", alt: "卡夫卡", caption: "卡夫卡" },
      { src: "/authors/nietzsche.jpg", alt: "尼采", caption: "尼采" },
      { src: "/authors/schopenhauer.jpg", alt: "叔本华", caption: "叔本华" },
      { src: "/authors/smith.jpg", alt: "亚当·斯密", caption: "亚当·斯密" },
      { src: "/authors/keynes.jpg", alt: "凯恩斯", caption: "凯恩斯" },
      { src: "/authors/lee.jpg", alt: "李明博", caption: "李明博" },
    ],
  },
]
